<?php
$tarifas = TarifasData::obtenerTarifas(); 
...
<form action="" id="hoteles" method="post" name="hoteles">
	...
	<div class="card container-fluid">
	  <div class="card-body">
			    ...
			    <div class="nk-block-between">
			        <div class="nk-block-head-content">
			            ...
			            <div class="nk-block-des text-soft">
			                <p>Tiene un total de <?php echo $total_tarifas; ?> tarifas.</p>
			            </div>
			        </div>
			        <div class="nk-block-head-content">
			            <div class="toggle-wrap nk-block-tools-toggle">
			                <div class="toggle-expand-content" data-content="pageMenu">
			                    <ul class="nk-block-tools g-3">
			                        <li><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#tarifa-agregar"><em class="icon ni ni-plus"></em><span>Agregar</span></a></li>
			                    </ul>
			                </div>
			            </div>
			        </div>
			            ...
			            <div class="card-inner p-0">
			                <div class="nk-tb-list nk-tb-ulist is-compact">
			                    <div class="nk-tb-item nk-tb-head">
			                        ...
			                        <div class="nk-tb-col"><span class="sub-text">Tarifa</span></div>
			                    ...
			                    <div class="nk-tb-item">
			                        ...
			                        <div class="nk-tb-col">
			                            <?php echo $tarifa->nombre_tarifa; ?>
			                        </div>
			                        <div class="nk-tb-col">
			                        	<?php if ($tarifa->estado_tarifa == 1) { ?>
			                        ...
			                        <div class="nk-tb-col nk-tb-col-check">
			                        	<button type="button" class="btn btn-warning edicion_tarifa" data-relacionado="<?php echo $tarifa->id; ?>"><em class="icon ni ni-edit-alt-fill"></em></button>
			                        </div>
			                    </div>
			                    <?php endforeach; ?>
			                </div>
			...
			<div class="modal fade" tabindex="-2" id="tarifa-agregar">
		        <div class="modal-dialog" role="document">
		            <div class="modal-content">
		                <div class="modal-header">
		                    <h5 class="modal-title">Registro de Tarifas</h5>
		                ...
		                <div class="modal-body">
		                    <form action="#" class="form-validate is-alter">
		                    	<div class="row gy-4">
									...
									<div class="col-6">
				                        <div class="form-group">
				                            <label class="form-label" for="precio_minimo">Precio Minimo</label>
				                            <div class="form-control-wrap">
				                                <input type="text" class="form-control input-double" id="precio_minimo" name="precio_minimo" required value="">
				                            </div>
				                        </div>
		                    		</div>
		                    		<div class="col-6">
				                        <div class="form-group">
				                            ...
				                            <div class="form-control-wrap">
				                                <input type="text" class="form-control input-double" id="precio_base" name="precio_base" required value="">
				                            </div>
				                        </div>
		                    		</div>
		                    		<div class="col-6">
		                        ...
		                        <div class="form-group row gy-gs">
		                        	...
		                        	<div class="col-6 text-right">
			                            <button type="button" class="btn btn-lg btn-primary registrar_tarifa">Registrar</button>
		                        	</div>
		                        </div>
		                    </form>
		                </div>
			...
			<div class="modal fade" tabindex="-1" id="tarifa-edicion">
		        <div class="modal-dialog" role="document">
		            <div class="modal-content">
		                <div class="modal-header">
		                    <h5 class="modal-title">Edición de Tarifas</h5>
		                    <a href="#" class="close" data-dismiss="modal" aria-label="Close">
		                        <em class="icon ni ni-cross"></em>
		                    </a>
		                </div>
		                <div class="modal-body">
		                    <form action="#" class="form-validate is-alter">
		                        ...
		                        <div class="form-group row gy-gs">
		                        	<div class="col-6 text-left">
			                            <button type="button" class="btn btn-lg btn-danger eliminar_tarifa">Eliminar</button>
		                        	</div>
		                        	<div class="col-6 text-right">
			                            <button type="button" class="btn btn-lg btn-primary actualizar_tarifa">Actualizar</button>
		                        	</div>
		                        </div>
		                    </form>
		                </div>
