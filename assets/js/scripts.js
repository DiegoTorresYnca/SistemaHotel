...
!function (NioApp, $) {
  ...
  NioApp.CurrentLink = function () {
    var _link = '.nk-menu-link, .menu-link, .nav-link',
        ...
        fileName = _currentURL.substring(_currentURL.lastIndexOf("/") + 1);
  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var dom_normal = '<"row justify-between g-2"<"col-7 col-sm-6 text-left"><"col-5 col-sm-6 text-right"<"datatable-filter"f>>><"datatable-wrap my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-left text-md-right"i>>';
